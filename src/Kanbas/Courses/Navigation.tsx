...
export default function CoursesNavigation() {
  ...
  return (
    <div id="wd-courses-navigation" className="wd list-group fs-5 rounded-0">
      ...
      className={`list-group-item border border-0
        ${pathname.includes("Modules") ? "active" : "text-danger"}`}>Modules
        </Link>
      <Link id="wd-course-piazza-link"  to="/Kanbas/Courses/1234/Piazza"
      className={`list-group-item border border-0
        ${pathname.includes("Piazza") ? "active" : "text-danger"}`}>Piazza</Link>
      <Link id="wd-course-zoom-link"    to="/Kanbas/Courses/1234/Zoom"
      className={`list-group-item border border-0
        ${pathname.includes("Zoom") ? "active" : "text-danger"}`}>Zoom</Link>
      ...
      className={`list-group-item border border-0
        ${pathname.includes("Quizzes") ? "active" : "text-danger"}`}>Quizzes
        </Link>
